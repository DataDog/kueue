...
tool (
	...
	sigs.k8s.io/cluster-inventory-api/plugins/secretreader/cmd/plugin
...
require (
	...
	k8s.io/code-generator v0.35.4 // Used not only as code-generator but also for compatibility_lifecycle (feature-gates docs) tool versioning.
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/cloudfront v1.65.4 // indirect
